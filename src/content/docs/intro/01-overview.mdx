...
- 新手建议先读：[`/docs/idea/01-research`](/docs/idea/01-research) → [`/docs/idea/02-projects`](/docs/idea/02-projects)
- 需要快速落地：[`/docs/tools/02-workflow`](/docs/tools/02-workflow) + [`/docs/review/01-structured`](/docs/review/01-structured)
- 关注工程效率：[`/docs/code/01-claude`](/docs/code/01-claude) + [`/docs/code/03-agents`](/docs/code/03-agents)

---
<p class="index-footnote"><strong>本书持续更新中</strong> · 视觉系统升级：2026-02-12 · 默认主题：暗色</p>
