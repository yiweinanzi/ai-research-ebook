...
**Sci-Reasoning** 通过 LLM+人工校验的方法，对 2023–2025 年 NeurIPS、ICML、ICLR 的 **3819 篇 Oral/Spotlight 论文**进行"学术谱系"建模。
...
flowchart TD
    ...
    style F fill:#1a2a3a,stroke:#007aff
```
